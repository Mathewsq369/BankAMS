                                    ...
                                    if (accountNumber.Count > 0)
                                    {
                                        ...
                                        if (proceed)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                try
                                                {
                                                    recipient = Convert.ToInt32(accountBalance[lookfor]) + transferAmount;
                                                    senderOfFunds = Convert.ToInt32(accountBalance[which_user]) - transferAmount;
                                                }
                                                catch (Exception ex)
                                                {
                                                    Console.WriteLine("The entered amount was either too low or too large");
                                                }
